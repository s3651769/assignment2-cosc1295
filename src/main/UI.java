...
public class UI extends Application {
	...
	selectprofile.setOnAction(e -> {	
		...
		root.add(selectionlabel, 0, 3);
        root.add(name,0,4,8,1);
        root.add(submitname, 0,5,8,1);
        root.add(clearname,1,5);
        ...
        submitname.setOnAction(s -> {
        	if (name.getText()!=null) {
                ...
                root.add(ivPic,0,3);}
        		root.add(profilename, 0, 1);
        		root.add(profilestatus, 0, 2);
        		root.add(profileage,0,4);
        		root.add(profilegender, 0, 5);
        		root.add(profilestate, 0, 6);
        		}
        		catch (Exception noperson) {
        			Text exceptionalert = new Text("Error finding person");
        			root.add(exceptionalert, 0, 1);
        		}
        	}
        });
	...
	addrelationship.setOnAction(e -> {
		...
		Button submitnames = new Button("Submit Names");
		Button clearnames = new Button("Clear Names");
		...
		root.add(selectionlabel1, 0, 3);
        root.add(name1,0,4,8,1);
        root.add(selectionlabel2, 0, 5);
        root.add(name2,0,6,8,1);
        root.add(selectionlabel3, 0, 7);
        root.add(relationshiptype, 0, 8,8,1);
        root.add(submitnames, 0,9,8,1);
        root.add(clearnames,1,9);
	...
	adduser.setOnAction(e -> {
        ...
        root.add(selectionlabel3, 0, 7);
        root.add(age, 0,8);
        root.add(selectionlabel4,0,9);
        root.add(imagepath,0,10);
        root.add(selectionlabel5,0,11);
        root.add(gender, 0, 12);
        root.add(selectionlabel6, 0, 13);
        root.add(state, 0, 14);
        root.add(submitnames, 0, 15);
        root.add(clearnames, 1, 15);
	...
	deleteuser.setOnAction(e -> {	
        ...
        if (name.getText()!=null) {
    		...
    		root.getChildren().clear();
    		Text successfuldelete = new Text(completion);
    		root.add(successfuldelete, 0, 1);
    		} 
	...
	menulist.getItems().add(selectprofile);
	menulist.getItems().add(showrelationship);
	menulist.getItems().add(addrelationship);
	menulist.getItems().add(adduser);
	menulist.getItems().add(deleteuser);
	menulist.getItems().add(exit);
